...
func RegisterArtistRoutes(app *fiber.App, db *gorm.DB) {
	...
	api := app.Group("/api")
	api.Get("/artists", requireEmployeeFeature(db, access.ArtistSearch, access.View), h.listArtists)
	api.Get("/artists/:id", requireEmployeeFeature(db, access.ArtistSearch, access.View), h.getArtist)
	api.Post("/artists", requireEmployeeFeature(db, access.ArtistManage, access.Edit), h.createArtist)
	api.Put("/artists/:id", requireEmployeeFeature(db, access.ArtistManage, access.Edit), h.updateArtist)
	api.Delete("/artists/:id", requireEmployeeFeature(db, access.ArtistSearch, access.Edit), h.deleteArtist)
	api.Get("/artists/:id/invitations", requireEmployeeFeature(db, access.ArtistInvitation, access.View), h.listInvitations)
	api.Put("/artists/:id/invitations", requireEmployeeFeature(db, access.ArtistInvitation, access.Edit), h.updateInvitations)
	api.Get("/performance-schedules", requireEmployeeFeature(db, access.ArtistScheduleView, access.View), h.listSchedules)
	api.Post("/performance-schedules", requireEmployeeFeature(db, access.ArtistScheduleCreate, access.Edit), h.replaceSchedules)
	api.Put("/concerts/:id/performance-schedules", requireEmployeeFeature(db, access.ArtistScheduleCreate, access.Edit), h.replaceConcertSchedules)
	api.Get("/performance-details", requireEmployeeFeature(db, access.ArtistPerformanceManage, access.View), h.listDetails)
	api.Post("/performance-details", requireEmployeeFeature(db, access.ArtistPerformanceManage, access.Edit), h.createDetail)
	api.Get("/artist-requirements", requireEmployeeFeature(db, access.ArtistPerformanceManage, access.View), h.listRequirements)
	api.Post("/artist-requirements", requireEmployeeFeature(db, access.ArtistPerformanceManage, access.Edit), h.createRequirement)
	api.Get("/artist-history", requireEmployeeFeature(db, access.ArtistHistory, access.View), h.listHistory)
	api.Get("/artist-dashboard", requireEmployeeFeature(db, access.ArtistDashboard, access.View), h.dashboard)
	h.seed()
}
