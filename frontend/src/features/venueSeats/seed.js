export const initialConcerts = [
  {
    ...
    zones: [
      { id: 'zone-a1', name: 'A1', color: '#ff2d2d', seats: 150, price: 3500, type: 'VIP', shape: 'rectangle', width: 12, height: 14, rotation: 0, z: 1, x: 34, y: 25 },
      { id: 'zone-a2', name: 'A2', color: '#ff2d2d', seats: 150, price: 3500, type: 'VIP', shape: 'rectangle', width: 12, height: 14, rotation: 0, z: 2, x: 55, y: 25 },
      { id: 'zone-b1', name: 'B1', color: '#5043f5', seats: 100, price: 2500, type: 'ปกติ', shape: 'rectangle', width: 12, height: 14, rotation: 0, z: 3, x: 22, y: 52 },
      { id: 'zone-b2', name: 'B2', color: '#5043f5', seats: 100, price: 2500, type: 'ปกติ', shape: 'rectangle', width: 12, height: 14, rotation: 0, z: 4, x: 42, y: 52 },
      { id: 'zone-b3', name: 'B3', color: '#5043f5', seats: 100, price: 2500, type: 'ปกติ', shape: 'rectangle', width: 12, height: 14, rotation: 0, z: 5, x: 62, y: 52 },
      { id: 'zone-c1', name: 'C1', color: '#5bd84f', seats: 50, price: 1500, type: 'ปกติ', shape: 'rectangle', width: 12, height: 12, rotation: 0, z: 6, x: 27, y: 78 },
      { id: 'zone-c2', name: 'C2', color: '#5bd84f', seats: 100, price: 1500, type: 'ปกติ', shape: 'rectangle', width: 12, height: 12, rotation: 0, z: 7, x: 48, y: 78 },
