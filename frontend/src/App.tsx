...
import VenueSeatsModule from './pages/Employee/venueSeats/VenueSeatsModule'
...
import RegistrationModule from './pages/Employee/registration/RegistrationModule'
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/search-concert" element={<Layout title="วางแผนหารจำหน่ายบัตร"><VenueSeatsModule /></Layout>} />
