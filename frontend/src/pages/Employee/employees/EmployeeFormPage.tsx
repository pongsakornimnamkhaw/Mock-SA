...
const JOB_ROLES: { value: EmployeeJobRole; label: string }[] = [
  ...
  { value: 'production_staff', label: 'พนักงานฝ่ายโปรดักชั่น' },
  { value: 'venue_staff', label: 'ฝ่ายสถานที่' },
  { value: 'marketing', label: 'ฝ่ายการตลาด' },
  { value: 'finance', label: 'ฝ่ายการเงิน' },
  { value: 'technical_staff', label: 'ฝ่ายเทคนิค' },
  { value: 'artist', label: 'ศิลปิน' },
  { value: 'artist_manager', label: 'ผู้จัดการศิลปิน' },
