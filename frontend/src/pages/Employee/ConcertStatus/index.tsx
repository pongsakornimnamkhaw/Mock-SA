          ...
          <Grid size={{ xs: 12, sm: 10.5 }}>
            <FormControl fullWidth size="small">
              <Select
                ...
                sx={{ bgcolor: 'white', borderRadius: 1, fontSize: '20px' }}
              >
                <MenuItem value="วางแผน">วางแผน</MenuItem>
                <MenuItem value="ยืนยันแล้ว">ยืนยันแล้ว</MenuItem>
                <MenuItem value="เลื่อนการจัด">เลื่อนการจัด</MenuItem>
                <MenuItem value="ยกเลิกการจัด">ยกเลิกการจัด</MenuItem>
                <MenuItem value="กำลังแสดง">กำลังแสดง</MenuItem>
